...
<template>
  <div class="datepicker" :class="{ weekmode: selectionMode === 'week' }">
    <div class="datepicker-header">
      <button @click.stop="prev" class="datepicker-prevbtn d-icon d-icon-arrow-left"></button>
      <label @click.stop="handleLabelClick">{{ label }}</label>
      <button @click.stop="next" class="datepicker-nextbtn d-icon d-icon-arrow-right"></button>
    </div>
    <div class="datepicker-body">
      <table :class="{ hidden: currentView !== 'date' }" @click.stop="handleDateTableClick" cellspacing="0">
        <tbody>
          <tr>
      ...
      <table @click.stop="handleYearTableClick" class="datepicker-yeartable" :class="{ hidden: currentView !== 'year' }">
        <tbody>
          <tr>
            <td @click.stop="prevTenYear" class="d-icon d-icon-arrow-left"></td>
          ...
          <tr>
            ...
            <td @click.stop="nextTenYear" class="d-icon d-icon-arrow-right"></td>
          </tr>
        </tbody>
      </table>

      <table @click.stop="handleMonthTableClick" class="datepicker-monthtable" :class="{ hidden: currentView !== 'month' }">
        <tbody>
          <tr>
    ...
    <div class="datepicker-footer" :class="{ hidden: currentView !== 'date' }">
      <span class="datepicker-timelabel" @click.stop="currentView = 'time'" v-if="showTime">{{ timeText }}</span>
      <button class="datepicker-todaybtn" @click.stop="changeToToday">{{ $t('datepicker.today') }}</button>
    </div>
  </div>
</template>
